...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'job_2020_01_01')) THEN
        CREATE TABLE job_new.job_2020_01_01
        (
            ...
            CONSTRAINT job_2020_01_01_pkey PRIMARY KEY (job_id),
            CONSTRAINT job_2020_01_01_created_date_time_check CHECK (created_date_time >= 1577836800 AND created_date_time < 1578268800),
        ...
        ALTER TABLE job_new.job_2020_01_01
            OWNER to postgres;

        -- Index: job_new.job_2020_01_01@_ix_job_cluster_id

        -- DROP INDEX job_new."job_new.job_2020_01_01@_ix_job_cluster_id";

        CREATE INDEX "job_new.job_2020_01_01@_ix_job_cluster_id"
            ON job_new.job_2020_01_01 USING btree
            (cluster_id COLLATE pg_catalog."default" ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@application_id

        -- DROP INDEX job_new."job_new.job_2020_01_01@application_id";

        CREATE INDEX "job_new.job_2020_01_01@application_id"
            ON job_new.job_2020_01_01 USING btree
            (application_id ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@application_id,created_date_time

        -- DROP INDEX job_new."job_new.job_2020_01_01@application_id,created_date_time";

        CREATE INDEX "job_new.job_2020_01_01@application_id,created_date_time"
            ON job_new.job_2020_01_01 USING btree
            (application_id ASC NULLS LAST, created_date_time ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@bundle_id

        -- DROP INDEX job_new."job_new.job_2020_01_01@bundle_id";

        CREATE INDEX "job_new.job_2020_01_01@bundle_id"
            ON job_new.job_2020_01_01 USING btree
            (bundle_id COLLATE pg_catalog."default" ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@created_date_time

        -- DROP INDEX job_new."job_new.job_2020_01_01@created_date_time";

        CREATE INDEX "job_new.job_2020_01_01@created_date_time"
            ON job_new.job_2020_01_01 USING btree
            (created_date_time DESC NULLS FIRST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@job_pipeline_id

        -- DROP INDEX job_new."job_new.job_2020_01_01@job_pipeline_id";

        CREATE INDEX "job_new.job_2020_01_01@job_pipeline_id"
            ON job_new.job_2020_01_01 USING btree
            (job_pipeline_id ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@modified_date_time

        -- DROP INDEX job_new."job_new.job_2020_01_01@modified_date_time";

        CREATE INDEX "job_new.job_2020_01_01@modified_date_time"
            ON job_new.job_2020_01_01 USING btree
            (modified_date_time ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@recording_id

        -- DROP INDEX job_new."job_new.job_2020_01_01@recording_id";

        CREATE INDEX "job_new.job_2020_01_01@recording_id"
            ON job_new.job_2020_01_01 USING btree
            (recording_id COLLATE pg_catalog."default" ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_01@scheduled_job_id

        -- DROP INDEX job_new."job_new.job_2020_01_01@scheduled_job_id";

        CREATE INDEX "job_new.job_2020_01_01@scheduled_job_id"
            ON job_new.job_2020_01_01 USING btree
