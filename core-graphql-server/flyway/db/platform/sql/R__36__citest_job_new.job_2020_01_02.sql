...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'job_2020_01_02')) THEN
        CREATE TABLE job_new.job_2020_01_02
        (
            ...
            CONSTRAINT job_2020_01_02_pkey PRIMARY KEY (job_id),
            CONSTRAINT job_2020_01_02_created_date_time_check CHECK (created_date_time >= 1578268800 AND created_date_time < 1578873600),
        ...
        ALTER TABLE job_new.job_2020_01_02
            OWNER to postgres;

        -- Index: job_new.job_2020_01_02@_ix_job_cluster_id

        -- DROP INDEX job_new."job_new.job_2020_01_02@_ix_job_cluster_id";

        CREATE INDEX "job_new.job_2020_01_02@_ix_job_cluster_id"
            ON job_new.job_2020_01_02 USING btree
            (cluster_id COLLATE pg_catalog."default" ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@application_id

        -- DROP INDEX job_new."job_new.job_2020_01_02@application_id";

        CREATE INDEX "job_new.job_2020_01_02@application_id"
            ON job_new.job_2020_01_02 USING btree
            (application_id ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@application_id,created_date_time

        -- DROP INDEX job_new."job_new.job_2020_01_02@application_id,created_date_time";

        CREATE INDEX "job_new.job_2020_01_02@application_id,created_date_time"
            ON job_new.job_2020_01_02 USING btree
            (application_id ASC NULLS LAST, created_date_time ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@bundle_id

        -- DROP INDEX job_new."job_new.job_2020_01_02@bundle_id";

        CREATE INDEX "job_new.job_2020_01_02@bundle_id"
            ON job_new.job_2020_01_02 USING btree
            (bundle_id COLLATE pg_catalog."default" ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@created_date_time

        -- DROP INDEX job_new."job_new.job_2020_01_02@created_date_time";

        CREATE INDEX "job_new.job_2020_01_02@created_date_time"
            ON job_new.job_2020_01_02 USING btree
            (created_date_time DESC NULLS FIRST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@job_pipeline_id

        -- DROP INDEX job_new."job_new.job_2020_01_02@job_pipeline_id";

        CREATE INDEX "job_new.job_2020_01_02@job_pipeline_id"
            ON job_new.job_2020_01_02 USING btree
            (job_pipeline_id ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@modified_date_time

        -- DROP INDEX job_new."job_new.job_2020_01_02@modified_date_time";

        CREATE INDEX "job_new.job_2020_01_02@modified_date_time"
            ON job_new.job_2020_01_02 USING btree
            (modified_date_time ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@recording_id

        -- DROP INDEX job_new."job_new.job_2020_01_02@recording_id";

        CREATE INDEX "job_new.job_2020_01_02@recording_id"
            ON job_new.job_2020_01_02 USING btree
            (recording_id COLLATE pg_catalog."default" ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: job_new.job_2020_01_02@scheduled_job_id

        -- DROP INDEX job_new."job_new.job_2020_01_02@scheduled_job_id";

        CREATE INDEX "job_new.job_2020_01_02@scheduled_job_id"
            ON job_new.job_2020_01_02 USING btree
