...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'recording_asset_2020_03_11')) THEN
      CREATE TABLE recording.recording_asset_2020_03_11
      (
          ...
          CONSTRAINT recording_asset_2020_03_11_pkey PRIMARY KEY (asset_id),
          CONSTRAINT recording_asset_2020_03_11_recording_id_check CHECK (recording_id::integer >= 920000000 AND recording_id::integer < 930000000)
      )
      ...
      ALTER TABLE recording.recording_asset_2020_03_11
          OWNER to postgres;
      -- Index: _ix_recording.recording_asset_2020_03_11@created_date_time

      -- DROP INDEX recording."_ix_recording.recording_asset_2020_03_11@created_date_time";

      CREATE INDEX "_ix_recording.recording_asset_2020_03_11@created_date_time"
          ON recording.recording_asset_2020_03_11 USING btree
          (created_date_time ASC NULLS LAST)
          TABLESPACE pg_default;
      -- Index: _ix_recording.recording_asset_2020_03_11@recording_id

      -- DROP INDEX recording."_ix_recording.recording_asset_2020_03_11@recording_id";

      CREATE INDEX "_ix_recording.recording_asset_2020_03_11@recording_id"
          ON recording.recording_asset_2020_03_11 USING btree
