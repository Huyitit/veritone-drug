...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'task_2019_12_49')) THEN
        CREATE TABLE job_new.task_2019_12_49
        (
            ...
            CONSTRAINT task_2019_12_49_pkey PRIMARY KEY (task_id),
            CONSTRAINT task_2019_12_49_created_date_time_check CHECK (created_date_time >= 1575244800 AND created_date_time < 1575849600),
        ...
        ALTER TABLE job_new.task_2019_12_49
            OWNER to postgres;

        -- Index: job_new.task_2019_12_49@application_id,created_date_time,task_s

        -- DROP INDEX job_new."job_new.task_2019_12_49@application_id,created_date_time,task_s";

        CREATE INDEX "job_new.task_2019_12_49@application_id,created_date_time,task_s"
            ON job_new.task_2019_12_49 USING btree
            (application_id, created_date_time, task_status COLLATE pg_catalog."default")
            TABLESPACE pg_default;

        -- Index: job_new.task_2019_12_49@created_date_time

        -- DROP INDEX job_new."job_new.task_2019_12_49@created_date_time";

        CREATE INDEX "job_new.task_2019_12_49@created_date_time"
            ON job_new.task_2019_12_49 USING btree
            (created_date_time)
            TABLESPACE pg_default;

        -- Index: job_new.task_2019_12_49@job_id

        -- DROP INDEX job_new."job_new.task_2019_12_49@job_id";

        CREATE INDEX "job_new.task_2019_12_49@job_id"
            ON job_new.task_2019_12_49 USING btree
            (job_id COLLATE pg_catalog."default")
            TABLESPACE pg_default;

        -- Index: job_new.task_2019_12_49@modified_date_time

        -- DROP INDEX job_new."job_new.task_2019_12_49@modified_date_time";

        CREATE INDEX "job_new.task_2019_12_49@modified_date_time"
            ON job_new.task_2019_12_49 USING btree
            (modified_date_time)
            TABLESPACE pg_default;

        -- Index: job_new.task_2019_12_49@recording_id

        -- DROP INDEX job_new."job_new.task_2019_12_49@recording_id";

        CREATE INDEX "job_new.task_2019_12_49@recording_id"
            ON job_new.task_2019_12_49 USING btree
