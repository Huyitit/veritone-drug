...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'recording_asset_2020_01_01')) THEN
        CREATE TABLE recording.recording_asset_2020_01_01
        (
            ...
            CONSTRAINT recording_asset_2020_01_01_pkey PRIMARY KEY (asset_id),
            CONSTRAINT recording_asset_2020_01_01_recording_id_check CHECK (recording_id::integer >= 820000000 AND recording_id::integer < 830000000)
        )
        ...
        ALTER TABLE recording.recording_asset_2020_01_01
            OWNER to postgres;

        -- Index: _ix_recording.recording_asset_2020_01_01@created_date_time

        -- DROP INDEX recording."_ix_recording.recording_asset_2020_01_01@created_date_time";

        CREATE INDEX "_ix_recording.recording_asset_2020_01_01@created_date_time"
            ON recording.recording_asset_2020_01_01 USING btree
            (created_date_time ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: _ix_recording.recording_asset_2020_01_01@recording_id

        -- DROP INDEX recording."_ix_recording.recording_asset_2020_01_01@recording_id";

        CREATE INDEX "_ix_recording.recording_asset_2020_01_01@recording_id"
            ON recording.recording_asset_2020_01_01 USING btree
