...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'task_2020_03_11')) THEN
      CREATE TABLE job_new.task_2020_03_11
      (
          ...
          CONSTRAINT task_2020_03_11_pkey PRIMARY KEY (task_id),
          CONSTRAINT task_2020_03_11_created_date_time_check CHECK (created_date_time >= 1583712000 AND created_date_time < 1584316800),
      ...
      ALTER TABLE job_new.task_2020_03_11
          OWNER to postgres;
      -- Index: job_new.task_2020_03_11@application_id,created_date_time,task_s

      -- DROP INDEX job_new."job_new.task_2020_03_11@application_id,created_date_time,task_s";

      CREATE INDEX "job_new.task_2020_03_11@application_id,created_date_time,task_s"
          ON job_new.task_2020_03_11 USING btree
          (application_id ASC NULLS LAST, created_date_time ASC NULLS LAST, task_status COLLATE pg_catalog."default" ASC NULLS LAST)
          TABLESPACE pg_default;
      -- Index: job_new.task_2020_03_11@created_date_time

      -- DROP INDEX job_new."job_new.task_2020_03_11@created_date_time";

      CREATE INDEX "job_new.task_2020_03_11@created_date_time"
          ON job_new.task_2020_03_11 USING btree
          (created_date_time ASC NULLS LAST)
          TABLESPACE pg_default;
      -- Index: job_new.task_2020_03_11@job_id

      -- DROP INDEX job_new."job_new.task_2020_03_11@job_id";

      CREATE INDEX "job_new.task_2020_03_11@job_id"
          ON job_new.task_2020_03_11 USING btree
          (job_id COLLATE pg_catalog."default" ASC NULLS LAST)
          TABLESPACE pg_default;
      -- Index: job_new.task_2020_03_11@modified_date_time

      -- DROP INDEX job_new."job_new.task_2020_03_11@modified_date_time";

      CREATE INDEX "job_new.task_2020_03_11@modified_date_time"
          ON job_new.task_2020_03_11 USING btree
          (modified_date_time ASC NULLS LAST)
          TABLESPACE pg_default;
      -- Index: job_new.task_2020_03_11@recording_id

      -- DROP INDEX job_new."job_new.task_2020_03_11@recording_id";

      CREATE INDEX "job_new.task_2020_03_11@recording_id"
          ON job_new.task_2020_03_11 USING btree
