...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'job_2019_12_49')) THEN
        CREATE TABLE job_new.job_2019_12_49
        (
            ...
            CONSTRAINT job_2019_12_49_pkey PRIMARY KEY (job_id),
            CONSTRAINT job_2019_12_49_created_date_time_check CHECK (created_date_time >= 1575244800 AND created_date_time < 1575849600),
        ...
        ALTER TABLE job_new.job_2019_12_49
            OWNER to postgres;

        -- Index: job_new.job_2019_12_49@_ix_job_cluster_id

        -- DROP INDEX job_new."job_new.job_2019_12_49@_ix_job_cluster_id";

        CREATE INDEX "job_new.job_2019_12_49@_ix_job_cluster_id"
            ON job_new.job_2019_12_49 USING btree
            (cluster_id COLLATE pg_catalog."default")
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@application_id

        -- DROP INDEX job_new."job_new.job_2019_12_49@application_id";

        CREATE INDEX "job_new.job_2019_12_49@application_id"
            ON job_new.job_2019_12_49 USING btree
            (application_id)
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@application_id,created_date_time

        -- DROP INDEX job_new."job_new.job_2019_12_49@application_id,created_date_time";

        CREATE INDEX "job_new.job_2019_12_49@application_id,created_date_time"
            ON job_new.job_2019_12_49 USING btree
            (application_id, created_date_time)
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@bundle_id

        -- DROP INDEX job_new."job_new.job_2019_12_49@bundle_id";

        CREATE INDEX "job_new.job_2019_12_49@bundle_id"
            ON job_new.job_2019_12_49 USING btree
            (bundle_id COLLATE pg_catalog."default")
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@created_date_time

        -- DROP INDEX job_new."job_new.job_2019_12_49@created_date_time";

        CREATE INDEX "job_new.job_2019_12_49@created_date_time"
            ON job_new.job_2019_12_49 USING btree
            (created_date_time DESC)
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@job_pipeline_id

        -- DROP INDEX job_new."job_new.job_2019_12_49@job_pipeline_id";

        CREATE INDEX "job_new.job_2019_12_49@job_pipeline_id"
            ON job_new.job_2019_12_49 USING btree
            (job_pipeline_id)
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@modified_date_time

        -- DROP INDEX job_new."job_new.job_2019_12_49@modified_date_time";

        CREATE INDEX "job_new.job_2019_12_49@modified_date_time"
            ON job_new.job_2019_12_49 USING btree
            (modified_date_time)
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@recording_id

        -- DROP INDEX job_new."job_new.job_2019_12_49@recording_id";

        CREATE INDEX "job_new.job_2019_12_49@recording_id"
            ON job_new.job_2019_12_49 USING btree
            (recording_id COLLATE pg_catalog."default")
            TABLESPACE pg_default;

        -- Index: job_new.job_2019_12_49@scheduled_job_id

        -- DROP INDEX job_new."job_new.job_2019_12_49@scheduled_job_id";

        CREATE INDEX "job_new.job_2019_12_49@scheduled_job_id"
            ON job_new.job_2019_12_49 USING btree
