...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'recording_asset_2019_12_49')) THEN
        CREATE TABLE recording.recording_asset_2019_12_49
        (
            ...
            CONSTRAINT recording_asset_2019_12_49_pkey PRIMARY KEY (asset_id),
            CONSTRAINT recording_asset_2019_12_49_recording_id_check CHECK (recording_id::integer >= 780000000 AND recording_id::integer < 790000000)
        )
        ...
        ALTER TABLE recording.recording_asset_2019_12_49
            OWNER to postgres;

        -- Index: _ix_recording.recording_asset_2019_12_49@created_date_time

        -- DROP INDEX recording."_ix_recording.recording_asset_2019_12_49@created_date_time";

        CREATE INDEX "_ix_recording.recording_asset_2019_12_49@created_date_time"
            ON recording.recording_asset_2019_12_49 USING btree
            (created_date_time)
            TABLESPACE pg_default;

        -- Index: _ix_recording.recording_asset_2019_12_49@recording_id

        -- DROP INDEX recording."_ix_recording.recording_asset_2019_12_49@recording_id";

        CREATE INDEX "_ix_recording.recording_asset_2019_12_49@recording_id"
            ON recording.recording_asset_2019_12_49 USING btree
