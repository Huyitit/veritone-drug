...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'recording_asset_2019_12_50')) THEN
        CREATE TABLE recording.recording_asset_2019_12_50
        (
            ...
            CONSTRAINT recording_asset_2019_12_50_pkey PRIMARY KEY (asset_id),
            CONSTRAINT recording_asset_2019_12_50_recording_id_check CHECK (recording_id::integer >= 790000000 AND recording_id::integer < 800000000)
        )
        ...
        ALTER TABLE recording.recording_asset_2019_12_50
            OWNER to postgres;

        -- Index: _ix_recording.recording_asset_2019_12_50@created_date_time

        -- DROP INDEX recording."_ix_recording.recording_asset_2019_12_50@created_date_time";

        CREATE INDEX "_ix_recording.recording_asset_2019_12_50@created_date_time"
            ON recording.recording_asset_2019_12_50 USING btree
            (created_date_time)
            TABLESPACE pg_default;

        -- Index: _ix_recording.recording_asset_2019_12_50@recording_id

        -- DROP INDEX recording."_ix_recording.recording_asset_2019_12_50@recording_id";

        CREATE INDEX "_ix_recording.recording_asset_2019_12_50@recording_id"
            ON recording.recording_asset_2019_12_50 USING btree
