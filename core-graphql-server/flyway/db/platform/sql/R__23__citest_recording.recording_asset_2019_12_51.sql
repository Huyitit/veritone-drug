...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'recording_asset_2019_12_51')) THEN
        CREATE TABLE recording.recording_asset_2019_12_51
        (
            ...
            CONSTRAINT recording_asset_2019_12_51_pkey PRIMARY KEY (asset_id),
            CONSTRAINT recording_asset_2019_12_51_recording_id_check CHECK (recording_id::integer >= 800000000 AND recording_id::integer < 810000000)
        )
        ...
        ALTER TABLE recording.recording_asset_2019_12_51
            OWNER to postgres;

        GRANT ALL ON TABLE recording.recording_asset_2019_12_51 TO postgres;

        -- Index: _ix_recording.recording_asset_2019_12_51@created_date_time

        -- DROP INDEX recording."_ix_recording.recording_asset_2019_12_51@created_date_time";

        CREATE INDEX "_ix_recording.recording_asset_2019_12_51@created_date_time"
            ON recording.recording_asset_2019_12_51 USING btree
            (created_date_time ASC NULLS LAST)
            TABLESPACE pg_default;


        -- Index: _ix_recording.recording_asset_2019_12_51@recording_id

        -- DROP INDEX recording."_ix_recording.recording_asset_2019_12_51@recording_id";

        CREATE INDEX "_ix_recording.recording_asset_2019_12_51@recording_id"
            ON recording.recording_asset_2019_12_51 USING btree
