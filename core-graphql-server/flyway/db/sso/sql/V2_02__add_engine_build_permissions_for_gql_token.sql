...
-- add perms: developer:build.invalidate, developer:build.upload, developer.build.create, "build:read", "build:create", "build:invalidate", "build:upload", "build:update"
...
SET "json"='{
	"rights": [
		...
		"build:read", "build:create", "build:invalidate", "build:upload", "build:update" 
	], 
