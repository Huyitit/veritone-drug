-- Add new permissions to the token:
-- "developer:build:update", "developer.engine.read", "developer.engine.update"
...
SET "json"='{
    "rights": ["asset:uri", "master", "recording:read", "recording:update", "asset:all", "task:read",
        ...
        "devops:querymonitor", "admin:org:update", "developer:build:update", "developer.engine.read", "developer.engine.update"],
    "internal": true,
    "isRevoked": false,
