...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'shared_url_2020_01_02')) THEN
      CREATE TABLE share.shared_url_2020_01_02
      (
          ...
          CONSTRAINT shared_url_2020_01_02_pkey PRIMARY KEY (id),
          CONSTRAINT shared_url_2020_01_02_no_duplicates UNIQUE (source_id, tdo_id, scheduled_job_id, start_date_time, stop_date_time, start_offset_ms, stop_offset_ms, settings, service_name, media_type)
      )
      ...
      ALTER TABLE share.shared_url_2020_01_02
          OWNER to postgres;

      -- Index: idx_shared_url_2020_01_02_created_date_time

      -- DROP INDEX share.idx_shared_url_2020_01_02_created_date_time;

      CREATE INDEX idx_shared_url_2020_01_02_created_date_time
          ON share.shared_url_2020_01_02 USING btree
      ...
      -- DROP TRIGGER update_date_modified ON share.shared_url_2020_01_02;

      CREATE TRIGGER update_date_modified
          BEFORE UPDATE 
          ON share.shared_url_2020_01_02
          FOR EACH ROW
