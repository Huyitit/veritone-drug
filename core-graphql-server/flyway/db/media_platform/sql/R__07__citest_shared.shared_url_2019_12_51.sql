...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'shared_url_2019_12_51')) THEN
      CREATE TABLE share.shared_url_2019_12_51
      (
          ...
          CONSTRAINT shared_url_2019_12_51_pkey PRIMARY KEY (id),
          CONSTRAINT shared_url_2019_12_51_no_duplicates UNIQUE (source_id, tdo_id, scheduled_job_id, start_date_time, stop_date_time, start_offset_ms, stop_offset_ms, settings, service_name, media_type)
      )
      ...
      ALTER TABLE share.shared_url_2019_12_51
          OWNER to postgres;

      -- GRANT SELECT ON TABLE share.shared_url_2019_12_51 TO yzhao;

      -- GRANT SELECT ON TABLE share.shared_url_2019_12_51 TO frobison;

      GRANT ALL ON TABLE share.shared_url_2019_12_51 TO postgres;

      -- GRANT SELECT ON TABLE share.shared_url_2019_12_51 TO readaccess;

      -- GRANT SELECT ON TABLE share.shared_url_2019_12_51 TO external_users;

      -- Index: idx_shared_url_2019_12_51_created_date_time

      -- DROP INDEX share.idx_shared_url_2019_12_51_created_date_time;

      CREATE INDEX idx_shared_url_2019_12_51_created_date_time
          ON share.shared_url_2019_12_51 USING btree
      ...
      -- DROP TRIGGER update_date_modified ON share.shared_url_2019_12_51;

      CREATE TRIGGER update_date_modified
          BEFORE UPDATE 
          ON share.shared_url_2019_12_51
          FOR EACH ROW
