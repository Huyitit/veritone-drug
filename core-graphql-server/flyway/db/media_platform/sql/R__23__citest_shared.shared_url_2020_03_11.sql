...
BEGIN
    IF (NOT EXISTS (SELECT * 
                    ...
                    AND  TABLE_NAME = 'shared_url_2020_03_11')) THEN
      CREATE TABLE share.shared_url_2020_03_11
      (
          ...
          CONSTRAINT shared_url_2020_03_11_pkey PRIMARY KEY (id),
          CONSTRAINT shared_url_2020_03_11_no_duplicates UNIQUE (source_id, tdo_id, scheduled_job_id, start_date_time, stop_date_time, start_offset_ms, stop_offset_ms, settings, service_name, media_type)
      )
      ...
      ALTER TABLE share.shared_url_2020_03_11
          OWNER to postgres;
      -- Index: idx_shared_url_2020_03_11_created_date_time

      -- DROP INDEX share.idx_shared_url_2020_03_11_created_date_time;

      CREATE INDEX idx_shared_url_2020_03_11_created_date_time
          ON share.shared_url_2020_03_11 USING btree
          (created_date_time ASC NULLS LAST)
          TABLESPACE pg_default;

      -- Trigger: update_date_modified

      -- DROP TRIGGER update_date_modified ON share.shared_url_2020_03_11;

      CREATE TRIGGER update_date_modified
          BEFORE UPDATE 
          ON share.shared_url_2020_03_11
          FOR EACH ROW
