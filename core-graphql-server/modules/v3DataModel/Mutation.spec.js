...
const resolvers = require('./Mutation.js')(serviceContext, serviceContext.config);
...
describe('#Mutation', function () {
  describe('#require', function () {
    it('should load module', function () {
      ...
      // VP-2581: +5 (createDestination, updateDestination, deleteDestination,
      // completeDestinationConnection, distributeAsset)
      // VE-26069: +1 (refreshDestinationOAuthUrl)
      chaiExpect(keys.length).to.equal(49);
