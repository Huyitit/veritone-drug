...
module.exports = function createFunction(serviceContext) {
  ...
  return {
    createTDOBatch: (root, args, context) => {
      ...
      return tdoBatch.createBatch(context, args);
    },
    cancelTDOBatchProcess: (root, args, context) => {
      if (!batchActionsEnabled) {
        throw new errors.NotImplemented({
          data: {
            batchActionsEnabled: batchActionsEnabled
      ...
      return tdoBatch.cancelTdoBatchProcess(context, args);
    }
  };
};
